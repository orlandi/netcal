classdef Tree < hgsetget
    ...
    methods (Access = protected)
        ...
        function createTreeCustomizations(tObj)
            ...
            tObj.jDropTarget = handle(javaObjectEDT('MLDropTarget'),'CallbackProperties');
            ...
            %set(CbProps,'DropCallback',@(src,e)onNodeDNDd(tObj,e, src));
            %set(CbProps,'DragOverCallback',@(src,e)onNodeDND(tObj,e, src));
            %set(CbProps,'DragEnterCallback',@(src,e)onNodeDND(tObj,e, src));
            set(tObj.jDropTarget,'DragOverCallback', @(src,e)onNodeDND(tObj,e, src));
            set(tObj.jDropTarget,'DropCallback', @(src,e)onNodeDND(tObj,e, src));
            %set(tObj.jDropTarget,'DragEnterCallback',@onNodeDND);
