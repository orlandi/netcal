...
% Modified. Sept 2018 - Javier Orlandi - NETCAL compatibility
...
if approachMode == 2
  ...
  while round <= numOfIC,
    ...
    if(pbar > 0)
      ncbar.setCurrentBarName(sprintf('Computing IC (%d/%d)', round, numOfIC));
      ncbar.update(round/numOfIC);
    end
...
if(pbar > 0)
  ...
  ncbar.setCurrentBarName('Cleaning up ICA results');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
