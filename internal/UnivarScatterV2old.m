function [xPositions, yPositions, Label, RangeCut, hList] = UnivarScatterV2old(data, varargin)
%--------------------------------------------------------------------------
...
if strcmp(Whiskers,'box')
    ...
    patch('XData', [0 1 1 0]*2*Width/WhiskersWidthRatio+XPositionsOrigin(i)-Width/WhiskersWidthRatio, ...
