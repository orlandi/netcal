...
%   See also plotStatistics, plotFigureOptions, baseOptions, optionsWindow
  ...
  properties
    ...
    pipelineProject = struct('plotType', {{'boxplot', 'distribution', 'univarscatter'}}, 'groupingOrder', {{'none', 'label average'}}, ...
                             ...
                             'factorAverageFunction', {{'mean', 'median', 'std', 'var', 'skewness', 'cv'}}, 'showMeanError', false, ...
                             'showSignificance', {{'none', 'partial', 'all'}}, 'significanceTest', {{'Mann-Whitney','Kolmogorov-Smirnov', 'Ttest2'}}, ...
                             'avoidCrossComparisons', true, 'computeIntraGroupComparisons', false, 'HolmBonferroniCorrection', false,...
