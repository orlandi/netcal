...
[ca_p, peel_p, exp_p] = configurePeeling(experiment, traces, ...
                                           ...
                                           'standardNoise', params.standardNoise, ...
                                           'schmittThresholds', params.schmittThresholds, ...
                                           'calciumMode', params.calciumMode, ...
                                           'additionalPlots', params.additionalPlots, ...
                                           'gamma', params.gamma, ...
                                           'dffmax', params.dffmax, ...
                                           'optimizationMethod', params.optimizationMethod, ...
                                           'verbose', false);
...
for it = 1:length(subset)
  ...
  if(isempty(params.standardNoise) && strcmpi(params.noiseEstimationMethod, 'individual'))
     peel_p.sdnoise = std(traces(:, selectedTrace))*0.75;
  end
